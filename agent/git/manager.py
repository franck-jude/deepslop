...
# 3 presses pour valider l'envoi
        time.sleep(0.3)
        pyautogui.press("enter")
        time.sleep(0.3)
        pyautogui.press("enter")
...
# Tentative de localisation du bouton Copier par image
            try:
                button = pyautogui.locateOnScreen("copy_button.png", confidence=0.8)
                if button:
                    cx, cy = pyautogui.center(button)
